...
def conditional_probability_iteration(data, beta, gamma, initial_infected_nodes, tol=0.001):
    N = data.num_nodes
    ...
    while i.max().item() > tol:
        ...
        infective_neighbors = torch.sparse_coo_tensor(
        ...
        s_new = (1 - beta * infective_neighbors) * s
...
def test_conditional_probability_iteration():
    ...
    results = conditional_probability_iteration(data, beta, gamma, initial_infected_nodes, tol)
